! function(t, e) {
 ...
 return function(t) {
  ...
  t.exports = {
   ...
   username: function(t) {
	   return new RegExp(/^[\u4e00-\u9fa5]{2,}$/).test(t.value)
   },
   mobilephone: function(t) {
	   return new RegExp(/09+\d{8}$/).test(t.value)
   },
   email: function(t) {
    return new RegExp(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/).test(t.value)
   },
   remark: function(t) {
	   return new RegExp(/^.{0,70}$/).test(t.value)
   }, 
   add_1: function(t) {
	return t.value.length && t.value.length > 5   
   },
   required: function(t) {
